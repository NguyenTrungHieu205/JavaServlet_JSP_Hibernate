...
<%--        </div>--%>
    ...
    <table class="table table-dark table-striped-columns">
        ...
        <tbody>
        <c:forEach items="${listMX}" var="mx">
        <tr>
            <th scope="row">${mx.id}</th>
            <td>${mx.ma}</td>
            <td>${mx.ten}</td>
            <td>
                <a href="/mau-sac/delete?id=${mx.id}" type="button" class="btn btn-danger">Delete</a>
               <a href="/mau-sac/detail?id=${mx.id}" type="button" class="btn btn-warning">Edit</a>
            </td>
        </tr>
        </c:forEach>
        </tbody>
